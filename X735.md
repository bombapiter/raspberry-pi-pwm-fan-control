Для активации работы кулера в Ubuntu 21.10 x64 на этом девайсе Geekworm Raspberry Pi 4B/3B+/3B X735 V2.5 Power Management используем fan.py, докер можно не использовать.
